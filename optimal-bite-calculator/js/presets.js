...
export const PRESET_SANDWICHES = {
  classic: {
    id: "classic",
    name: "Classic Naadan Burger",
    tagline: "Standard vazhipaad airframe • Oru normal setup",
  ...
  engineersDream: {
    id: "engineersDream",
    name: "⭐ Pwoli Engineer's Dream",
    tagline: "100% Kidilan Mathematical Airframe • Kadichoo!",
  ...
  breadMonster: {
    id: "breadMonster",
    name: "Bread Rakshas (Monster)",
    tagline: "Bread koodi chathu • Carb monolith overkill",
  ...
  tomatoDisaster: {
    id: "tomatoDisaster",
    name: "Thakkali Kozhappam (Disaster)",
    tagline: "Thakkali chaadi pokum • Slippery hazard",
  ...
  sauceFlood: {
    id: "sauceFlood",
    name: "Sauce Vellappokkam (Flood)",
    tagline: "Kuppayam motham theerum • Liquid tsunami",
  ...
  zeroGSub: {
    id: "zeroGSub",
    name: "Parakkum Zero-G Sub",
    tagline: "NASA Crumb-Free Roll • Pwoli setup",
